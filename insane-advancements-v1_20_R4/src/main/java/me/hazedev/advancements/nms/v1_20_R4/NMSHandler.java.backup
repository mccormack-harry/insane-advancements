package me.hazedev.advancements.nms.v1_20_R4;
...
import net.minecraft.server.v1_20_R4.AdvancementDisplay;
import net.minecraft.server.v1_20_R4.AdvancementFrameType;
import net.minecraft.server.v1_20_R4.AdvancementProgress;
import net.minecraft.server.v1_20_R4.AdvancementRewards;
import net.minecraft.server.v1_20_R4.Criterion;
import net.minecraft.server.v1_20_R4.CriterionTriggerImpossible;
import net.minecraft.server.v1_20_R4.IChatBaseComponent;
import net.minecraft.server.v1_20_R4.MinecraftKey;
import net.minecraft.server.v1_20_R4.PacketPlayInAdvancements;
import net.minecraft.server.v1_20_R4.PacketPlayOutAdvancements;
import net.minecraft.server.v1_20_R4.PacketPlayOutSelectAdvancementTab;
...
public class NMSHandler extends me.hazedev.advancements.api.nms.NMSHandler {
    ...
    Map<UUID, Map<NamespacedKey, net.minecraft.server.v1_20_R4.Advancement>> advancementCache = new HashMap<>();
    ...
    private void addToCache(@NotNull Player player, @NotNull net.minecraft.server.v1_20_R4.Advancement advancement) {
        advancementCache.putIfAbsent(player.getUniqueId(), new HashMap<>());
        Map<NamespacedKey, net.minecraft.server.v1_20_R4.Advancement> cache = advancementCache.get(player.getUniqueId());
        cache.put(convert(advancement.getName()), advancement);
    }

    @Nullable
    private net.minecraft.server.v1_20_R4.Advancement getCachedAdvancement(@NotNull Player player, @NotNull NamespacedKey key) {
        Map<NamespacedKey, net.minecraft.server.v1_20_R4.Advancement> cache = advancementCache.get(player.getUniqueId());
        if (cache != null)
    ...
    public void updateAdvancement(@NotNull Player player, @NotNull Advancement advancement) {
        ...
        net.minecraft.server.v1_20_R4.Advancement nmsParent = null;
        if (parent != null) {
    ...
    public void sendToasts(@NotNull Player player, @NotNull Advancement... advancements) {
        ...
        removePacketBuilder.remove.addAll(packetBuilder.nmsAdvancements.stream().map(net.minecraft.server.v1_20_R4.Advancement::getName).collect(Collectors.toList()));
    ...
    public static net.minecraft.server.v1_20_R4.ItemStack convert(@NotNull ItemStack item) {
    ...
    public class AdvancementsPacketBuilder {
        ...
        protected final Collection<net.minecraft.server.v1_20_R4.Advancement> nmsAdvancements = new ArrayList<>();
        ...
        public void addAdvancementAndChildren(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_20_R4.Advancement parent) {
            if (advancement.isVisible(player)) {
                net.minecraft.server.v1_20_R4.Advancement nmsAdvancement = addAdvancement(advancement, parent);
        ...
        @NotNull
        public net.minecraft.server.v1_20_R4.Advancement addAdvancement(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_20_R4.Advancement parent) {

            net.minecraft.server.v1_20_R4.AdvancementProgress nmsProgress = new net.minecraft.server.v1_20_R4.AdvancementProgress();
            ...
            net.minecraft.server.v1_20_R4.Advancement nmsAdvancement = new net.minecraft.server.v1_20_R4.Advancement(convert(advancement.getKey()), parent, nmsDisplay, nmsRewards, criteria, requirements);
