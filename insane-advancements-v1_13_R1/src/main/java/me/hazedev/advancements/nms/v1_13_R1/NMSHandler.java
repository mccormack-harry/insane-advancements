package me.hazedev.advancements.nms.v1_13_R1;
...
public class NMSHandler extends me.hazedev.advancements.api.nms.NMSHandler {
    ...
    Map<UUID, Map<NamespacedKey, net.minecraft.server.v1_13_R1.Advancement>> advancementCache = new HashMap<>();
    ...
    private void addToCache(@NotNull Player player, @NotNull net.minecraft.server.v1_13_R1.Advancement advancement) {
        advancementCache.putIfAbsent(player.getUniqueId(), new HashMap<>());
        Map<NamespacedKey, net.minecraft.server.v1_13_R1.Advancement> cache = advancementCache.get(player.getUniqueId());
        cache.put(convert(advancement.getName()), advancement);
    }

    @Nullable
    private net.minecraft.server.v1_13_R1.Advancement getCachedAdvancement(@NotNull Player player, @NotNull NamespacedKey key) {
        Map<NamespacedKey, net.minecraft.server.v1_13_R1.Advancement> cache = advancementCache.get(player.getUniqueId());
        if (cache != null)
    ...
    public void updateAdvancement(@NotNull Player player, @NotNull Advancement advancement) {
        ...
        net.minecraft.server.v1_13_R1.Advancement nmsParent = null;
        if (parent != null) {
    ...
    public void sendToasts(@NotNull Player player, @NotNull Advancement... advancements) {
        ...
        removePacketBuilder.remove.addAll(packetBuilder.nmsAdvancements.stream().map(net.minecraft.server.v1_13_R1.Advancement::getName).collect(Collectors.toList()));
    ...
    public static net.minecraft.server.v1_13_R1.ItemStack convert(@NotNull ItemStack item) {
    ...
    public class AdvancementsPacketBuilder {
        ...
        protected final Collection<net.minecraft.server.v1_13_R1.Advancement> nmsAdvancements = new ArrayList<>();
        ...
        public void addAdvancementAndChildren(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_13_R1.Advancement parent) {
            if (advancement.isVisible(player)) {
                net.minecraft.server.v1_13_R1.Advancement nmsAdvancement = addAdvancement(advancement, parent);
        ...
        @NotNull
        public net.minecraft.server.v1_13_R1.Advancement addAdvancement(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_13_R1.Advancement parent) {

            net.minecraft.server.v1_13_R1.AdvancementProgress nmsProgress = new net.minecraft.server.v1_13_R1.AdvancementProgress();
            ...
            net.minecraft.server.v1_13_R1.Advancement nmsAdvancement = new net.minecraft.server.v1_13_R1.Advancement(convert(advancement.getKey()), parent, nmsDisplay, nmsRewards, criteria, requirements);
