package me.hazedev.advancements.nms.v1_20_R3;
...
import net.minecraft.server.v1_20_R3.AdvancementDisplay;
import net.minecraft.server.v1_20_R3.AdvancementFrameType;
import net.minecraft.server.v1_20_R3.AdvancementProgress;
import net.minecraft.server.v1_20_R3.AdvancementRewards;
import net.minecraft.server.v1_20_R3.Criterion;
import net.minecraft.server.v1_20_R3.CriterionTriggerImpossible;
import net.minecraft.server.v1_20_R3.IChatBaseComponent;
import net.minecraft.server.v1_20_R3.MinecraftKey;
import net.minecraft.server.v1_20_R3.PacketPlayInAdvancements;
import net.minecraft.server.v1_20_R3.PacketPlayOutAdvancements;
import net.minecraft.server.v1_20_R3.PacketPlayOutSelectAdvancementTab;
...
public class NMSHandler extends me.hazedev.advancements.api.nms.NMSHandler {
    ...
    Map<UUID, Map<NamespacedKey, net.minecraft.server.v1_20_R3.Advancement>> advancementCache = new HashMap<>();
    ...
    private void addToCache(@NotNull Player player, @NotNull net.minecraft.server.v1_20_R3.Advancement advancement) {
        advancementCache.putIfAbsent(player.getUniqueId(), new HashMap<>());
        Map<NamespacedKey, net.minecraft.server.v1_20_R3.Advancement> cache = advancementCache.get(player.getUniqueId());
        cache.put(convert(advancement.getName()), advancement);
    }

    @Nullable
    private net.minecraft.server.v1_20_R3.Advancement getCachedAdvancement(@NotNull Player player, @NotNull NamespacedKey key) {
        Map<NamespacedKey, net.minecraft.server.v1_20_R3.Advancement> cache = advancementCache.get(player.getUniqueId());
        if (cache != null)
    ...
    public void updateAdvancement(@NotNull Player player, @NotNull Advancement advancement) {
        ...
        net.minecraft.server.v1_20_R3.Advancement nmsParent = null;
        if (parent != null) {
    ...
    public void sendToasts(@NotNull Player player, @NotNull Advancement... advancements) {
        ...
        removePacketBuilder.remove.addAll(packetBuilder.nmsAdvancements.stream().map(net.minecraft.server.v1_20_R3.Advancement::getName).collect(Collectors.toList()));
    ...
    public static net.minecraft.server.v1_20_R3.ItemStack convert(@NotNull ItemStack item) {
    ...
    public class AdvancementsPacketBuilder {
        ...
        protected final Collection<net.minecraft.server.v1_20_R3.Advancement> nmsAdvancements = new ArrayList<>();
        ...
        public void addAdvancementAndChildren(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_20_R3.Advancement parent) {
            if (advancement.isVisible(player)) {
                net.minecraft.server.v1_20_R3.Advancement nmsAdvancement = addAdvancement(advancement, parent);
        ...
        @NotNull
        public net.minecraft.server.v1_20_R3.Advancement addAdvancement(@NotNull Advancement advancement, @Nullable net.minecraft.server.v1_20_R3.Advancement parent) {

            net.minecraft.server.v1_20_R3.AdvancementProgress nmsProgress = new net.minecraft.server.v1_20_R3.AdvancementProgress();
            ...
            net.minecraft.server.v1_20_R3.Advancement nmsAdvancement = new net.minecraft.server.v1_20_R3.Advancement(convert(advancement.getKey()), parent, nmsDisplay, nmsRewards, criteria, requirements);
